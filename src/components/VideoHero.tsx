...
export const VideoHero: React.FC = () => {
  ...
  useEffect(() => {
    if (videoRef.current) {
      // Force play to ensure compatibility with browser autoplay policies
  ...
  return (
    <section id="home" className="relative w-full mt-[76px] lg:mt-[88px] aspect-video lg:aspect-auto lg:h-[calc(100vh-88px)] bg-[#eed5d0] overflow-hidden flex items-center">
      {/* Video Background */}
      <div className="absolute inset-0 z-0">
        <video
          ...
          preload="auto"
        >
          <source src="/banner/banner-video.webm" type="video/webm" />
