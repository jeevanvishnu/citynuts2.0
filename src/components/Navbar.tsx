...
interface NavbarProps {
  ...
  currentPage: 'home' | 'products' | 'about' | 'contact' | 'product-detail' | 'cart' | 'wishlist' | 'checkout' | 'login';
...
const megaMenuData: Record<string, any> = {
  'Dates': {
    ...
    featured: { name: 'Medjool Dates', weight: '500g', rating: '4.9', reviews: '2.1k', price: '₹599', oldPrice: '₹799', img: '/productimages/imgi_18_AJWA-DATES-LARGE.png' },
  ...
  'Nuts': {
    ...
    featured: { name: 'Premium Almonds', weight: '500g', rating: '4.8', reviews: '1.5k', price: '₹699', oldPrice: '₹899', img: '/productimages/imgi_24_almond3.png.webp' },
  ...
  'Dry Fruits': {
    ...
    featured: { name: 'Afghan Figs', weight: '250g', rating: '4.7', reviews: '850', price: '₹499', oldPrice: '₹599', img: '/productimages/imgi_19_dryfruit.png.webp' },
  ...
  'Chocolates': {
    ...
    featured: { name: 'Almond Truffles', weight: '200g', rating: '4.9', reviews: '1.2k', price: '₹399', oldPrice: '₹499', img: '/productimages/imgi_479_4.png' },
  ...
  'Seeds': {
    ...
    featured: { name: 'Roasted Pumpkin', weight: '250g', rating: '4.6', reviews: '900', price: '₹299', oldPrice: '₹399', img: '/productimages/imgi_82_1-7-460x460.png.webp' },
  ...
  'Spices': {
    ...
    featured: { name: 'Kashmiri Saffron', weight: '5g', rating: '5.0', reviews: '3.4k', price: '₹1499', oldPrice: '₹1899', img: '/productimages/imgi_16_1.png.webp' },
  ...
  'Gifts': {
    ...
    featured: { name: 'Royal Hamper', weight: '1kg', rating: '4.9', reviews: '500', price: '₹2499', oldPrice: '₹2999', img: '/productimages/imgi_90_premium-nuts-2048x2048.png' },
